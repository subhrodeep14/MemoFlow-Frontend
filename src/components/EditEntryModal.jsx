...
//     const res =
//       await entryApi.getAvailableSlNumbers(
//         year
//       );
...
await entryApi.updateEntry(
  ...
  form
      ...
      setForm({ slNo: "", receiverCompany: "", receiverCompanyId: "", purpose: "", purposeId: "", memoSuffix: "", description: "" });
      onSuccess?.();
      onClose?.();
    } catch (err) {
      console.error(err);
...
overflow-hidden
          ...
          >
            ...
            <div className="shrink-0 flex items-center justify-between px-5 py-3.5 border-b border-slate-100 dark:border-slate-800">
              <div>
                <h2 className="text-sm font-semibold text-slate-900 dark:text-white">Edit Memo</h2>
...
onChange={(e) => {
  ...
  */
  ...
  <input
    ...
    placeholder="SD/WC , KEIIP/KMC , PROJECT-A"
    className="
      w-full
      h-10
